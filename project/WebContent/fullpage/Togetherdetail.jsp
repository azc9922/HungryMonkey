...
<div class="wrapper">
   ...
   <table>
      ...
      <tr style="height: 41px;">
         <!-- 4칸 병합 -->
         <td id="writer"><a href="../fullpage/together.jsp"><input type="button" value="목록" /></a>
         <td id="writer"><a href="Tomodify.jsp?bno=<%=vo.getBno()%>"><input type="button" value="수정" /></a>
         <td id="writer" colspan="3"><a href="TodeleteOk.jsp?bno=<%=vo.getBno()%>"><input type="button" value="삭제" /></a>
